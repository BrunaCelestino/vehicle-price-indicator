...
public enum ProcessErrorType {
    ...
    VEHICLE_ALREADY_REGISTERED("CPI0002", "Não foi possível cadastrar veículo. Placa já cadastrada."),
    ...
    INDICATOR_NOT_FOUND("CPI0007", "Nenhum indicador foi encontrado para os critérios informados.");
